    ...
    for fam_id in families:
        ...
        if family.married:
            if family.married > currentDate:
                ...
                warnings.append(
                    f'ANOMALY: FAMILY: US01, line {num},{family.hname} and {family.wname} are married after current date')
    return warnings
    ...
    for fam_id in families:
        ...
        if family.divorced:
            if family.divorced > currentDate:
                ...
                warnings.append(
                    f'ANOMALY: FAMILY: US01, line {num},{family.hname} and {family.wname} are divorced after current date')
    return warnings
        ...
        for child_id in family.children:
            ...
            if individual.birth != None and family.married != None:
                if (individual.birth < family.married):
                    ...
                    warnings.append(
                        f'ANOMALY: FAMILY: US08, line {num},{individual.name} was born before marriage of parents')
    return warnings


def check_BirthAfterDivorceOfParents(individuals, families,
                                     tag_positions):  ##US 08 born not more than 9 months after their divorce
    warnings = []
    for fam_id in families:
        family = families[fam_id]
        for child_id in family.children:
            ...
            if individual.birth != None and family.married != None:
                if individual.birth != None and family.divorced != None:
                    ...
                    if (divorceDayDifference.days < -275):
                        num = tag_positions[child_id]['BIRT']
                        warnings.append(
                            f'ANOMALY: FAMILY: US08, line {num},{individual.name} born more than 9 months after divorce of parents')
    return warnings
            ...
            if family.wid != None:
                ...
                if individual_child.birth != None and individual_mother.death != None:
                    if individual_child.birth > individual_mother.death:
                        num = tag_positions[child_id]['BIRT']
                        warnings.append(
                            f'ANOMALY: FAMILY: US09, line{num},{individual_child.name} born after death of mother {individual_mother.name}')
    return warnings
            ...
            if family.hid != None:
                ...
                if individual_child.birth != None and individual_father.death != None:
                    ...
                    if diff.days < -275:
                        num = tag_positions[child_id]['BIRT']
                        warnings.append(
                            f'ANOMALY: FAMILY: US09, line{num},{individual_child.name} born 9 months after death of father {individual_father.name}')
    return warnings
        ...
        if family.wid != None:
            ...
            for child_id in family.children:
                ...
                if individual_father.age != None and individual_father.age < 14:
                    ...
                    warnings.append(
                        f'ANOMALY: FAMILY: US10, line{num}, {individual_father.name} Father of child {individual_child.name} is less than 14 years old')
                if individual_mother.age != None and individual_mother.age < 14:
                    num = tag_positions[family.wid]['BIRT']
                    warnings.append(
                        f'ANOMALY: FAMILY: US10, line{num}, {individual_mother.name} Mother of child {individual_child.name} is less than 14 years old')
    return warnings
            ...
            for child_id in family.children:
                ...
                if individual_father.age != None and individual_child.age != None:
                    ...
                    if (diff >= 80):
                        num = tag_positions[family.hid]['BIRT']
                        warnings.append(
                            f'ANOMALY: FAMILY: US12, line{num}, {individual_father.name} Father of child {individual_child.name} is elder by 80 or more years')
                if individual_mother.age != None and individual_child.age != None:
                    diff = individual_mother.age - individual_child.age
                    if (diff >= 60):
                        num = tag_positions[family.wid]['BIRT']
                        warnings.append(
                            f'ANOMALY: FAMILY: US12, line{num}, {individual_mother.name} Mother of child {individual_child.name} is elder by 60 or more years')
    return warnings
